...
#define DMA_CHANNEL_ADC				1							// Using DMA channel 0 for ADC transfer
#define DMA_CHANNEL_TX_LEUART	    0
...
#define PROX_SENSOR					((unsigned char )'D')
...
#define CircularBufferTest			true
...
// User can choose to use DMA for ADC
...
#define USE_DMA_LEUART		1

#if (USE_DMA_LEUART == 1)
#define DMA_ON_LEUART
#endif


// LESENSE PASSWORD PROTECTION
#define PASSWORD_THRESHOLD 		192
#define PAD4_SLIDER_THRESHOLD   40
#define PAD1_SLIDER_THRESHOLD	15
